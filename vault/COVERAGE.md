...
- `radar` ← `hurricane-irma-radar-loop.gif`, `rig--blob.gifcities.org_gifcities_2RO5SN3IFIDBUAFOOVBDCFJ7J6V4DRXR.gif`
...
- `tape` ← `barcode-scan-receipt.gif`, `f16-hud-gcas.gif`, `scope-envelope-violin.gif`
- `queueState` ← `solari-departure-flap.gif`
- `mfd` ← `f16-hud-gcas.gif`
- `hardCut` ← `barcode-scan-receipt.gif`, `solari-departure-flap.gif`
...
- `globe` ← `hologlobe--blob.gifcities.org_gifcities_2442E47OQDW3JQT5LC2S3S2O6QNUVCEW.gif`, `hologlobe--blob.gifcities.org_gifcities_2BDK66BWLK42ADEG52TMSEUEDO6IZDTX.gif`, `hologlobe--blob.gifcities.org_gifcities_2CW2JW7CEZP4FXCUBBNI2EPWDDLXQQOI.gif`
